...
[![PkgGoDev](https://pkg.go.dev/badge/gpt3)](https://pkg.go.dev/gpt3)
...
Check out the go docs for more detailed documentation on the types and methods provided: https://pkg.go.dev/gpt3
